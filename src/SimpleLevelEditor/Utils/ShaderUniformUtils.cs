...
public static class ShaderUniformUtils
{
	...
	{
		Graphics.Gl.Uniform2(uniformLocation, value.X, value.Y);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Set(int uniformLocation, Vector3 value)
	{
		Graphics.Gl.Uniform3(uniformLocation, value.X, value.Y, value.Z);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Set(int uniformLocation, Vector4 value)
	{
		Graphics.Gl.Uniform4(uniformLocation, value.X, value.Y, value.Z, value.W);
	}
