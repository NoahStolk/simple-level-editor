...
public static class ImGuiUtils
{
	public static bool ColorEdit3Rgb(ReadOnlySpan<char> label, ref Rgb rgb)
	{
		...
		if (edited)
			rgb = new Rgb((byte)(vector.X * byte.MaxValue), (byte)(vector.Y * byte.MaxValue), (byte)(vector.Z * byte.MaxValue));
	...
	public static bool ColorEdit4Rgba(ReadOnlySpan<char> label, ref Rgba rgba)
	{
		...
		if (edited)
			rgba = new Rgba((byte)(vector.X * byte.MaxValue), (byte)(vector.Y * byte.MaxValue), (byte)(vector.Z * byte.MaxValue), (byte)(vector.W * byte.MaxValue));
